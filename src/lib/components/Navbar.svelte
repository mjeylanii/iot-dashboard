...
<div class="fixed z-50 px-8 mb-8 rounded navbar top-10 bg-base-300 shadow-md">
	...
	<div class="flex navbar-end">
		<ul class="menu menu-horizontal">
			<li>
				<button on:click={() => showUserPage.set(false)}>
					<Icon src={AiOutlineHome} class="w-5 h-5 font-extrabold" />
				</button>
			</li>
			<li>
				<button on:click={() => showUserPage.set(true)}>
					<Icon src={AiOutlineUser} class="w-5 h-5 font-extrabold" />
				</button>
			</li>
			<li>
				<label for="info-modal">
					<Icon src={AiOutlineInfoCircle} class="w-5 h-5 font-extrabold" />
				</label>
			</li>
			<li>
				<label for="settings-modal">
					<Icon src={AiOutlineSetting} class="w-5 h-5 font-extrabold" />
				</label>
			</li>
		</ul>
